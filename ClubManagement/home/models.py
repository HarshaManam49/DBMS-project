...
class ClubIdentifier(models.Model):
    ...
    def get_all_users():
        ...
        return records
club_identifier_data=[
    {"username":"vicetechnical@user","club_name":"technical","category":"SC"},
    {"username":"vicecultural@user","club_name":"cultural","category":"SC"},
    {"username":"vicesports@user","club_name":"sports","category":"SC"},
    {"username":"musicclub@user","club_name":"cultural","category":"C"},
    {"username":"danceclub@user","club_name":"cultural","category":"C"},
    {"username":"fineartsclub@user","club_name":"cultural","category":"C"},
    {"username":"yogaclub@user","club_name":"cultural","category":"C"},
    {"username":"ebsbclub@user","club_name":"cultural","category":"C"},
    {"username":"literaryanddebatingclub@user","club_name":"cultural","category":"C"},
    {"username":"mediaclub@user","club_name":"cultural","category":"C"},
    {"username":"photographyclub@user","club_name":"cultural","category":"C"},
    {"username":"netsecclub@user","club_name":"technical","category":"C"},
    {"username":"webdevclub@user","club_name":"technical","category":"C"},
    {"username":"competitivecodingclub@user","club_name":"technical","category":"C"},
    {"username":"iotclub@user","club_name":"technical","category":"C"},
    {"username":"roboticsclub@user","club_name":"technical","category":"C"},
    {"username":"cicoptclub@user","club_name":"technical","category":"C"},
    {"username":"scienceclub@user","club_name":"technical","category":"C"},
    {"username":"volleyballclub@user","club_name":"sports","category":"C"},
    {"username":"basketballclub@user","club_name":"sports","category":"C"},
    {"username":"cricketclub@user","club_name":"sports","category":"C"},
    {"username":"badmintonclub@user","club_name":"sports","category":"C"},
    {"username":"tabletennisclub@user","club_name":"sports","category":"C"},
    {"username":"carromclub@user","club_name":"sports","category":"C"},
    {"username":"chessclub@user","club_name":"sports","category":"C"},
    {"username":"kabbadiclub@user","club_name":"sports","category":"C"},
    {"username":"athleticsfieldclub@user","club_name":"sports","category":"C"},
    {"username":"athleticstrackclub@user","club_name":"sports","category":"C"},
    {"username":"footballclub@user","club_name":"sports","category":"C"},
    {"username":"throwballclub@user","club_name":"sports","category":"C"},
    {"username":"sportsincharge@user","club_name":"sports","category":"C"},
    {"username":"culturalincharge@user","club_name":"cultural","category":""},
    {"username":"technicalincharge@user","club_name":"technical","category":""}
]
for data in club_identifier_data:
    obj = ClubIdentifier(**data)
    obj.save()
